...
static __inline__ FILE* tmpfile() {
 ...
 for (i = 0; i < 100; i++) {
  ...
  if (asprintf(&path, "/system/tmp/tmpfile.%d-%u", p, r) == -1) return ((void*)0);
...
{
    rb_obj_write((VALUE)(klass), (VALUE *)(&((((struct RClass*)(klass))->ptr)->origin_)), (VALUE)(origin), "/home/builder/.magisk-build/ruby/src/internal.h", 1091);
...
{
    rb_obj_write((VALUE)(iclass), (VALUE *)(&((((struct RClass*)(iclass))->ptr)->includer)), (VALUE)(klass), "/home/builder/.magisk-build/ruby/src/internal.h", 1098);
}
...
RCLASS_SET_SUPER(VALUE klass, VALUE super)
{
 ...
 rb_class_subclass_add(super, klass);
    ...
    rb_obj_write((VALUE)(klass), (VALUE *)(&((struct RClass*)(klass))->super), (VALUE)(super), "/home/builder/.magisk-build/ruby/src/internal.h", 1115);
    return super;
}
...
extern int ruby_stack_grow_direction;
...
{
 ((!list_empty_(h, "/home/builder/.magisk-build/ruby/src/ccan/list/list.h" ":" "328")) ? ((void) (0)) : __assert2("/home/builder/.magisk-build/ruby/src/ccan/list/list.h", 328, __PRETTY_FUNCTION__, "!list_empty(h)"));
 list_del_(n, "/home/builder/.magisk-build/ruby/src/ccan/list/list.h" ":" "329");
}
...
{
 if (list_empty_(h, "/home/builder/.magisk-build/ruby/src/ccan/list/list.h" ":" "399"))
  return ((void*)0);
...
static inline const void *list_pop_(const struct list_head *h, size_t off)
{
 ...
 if (list_empty_(h, "/home/builder/.magisk-build/ruby/src/ccan/list/list.h" ":" "425"))
  return ((void*)0);
 n = h->n.next;
 list_del_(n, "/home/builder/.magisk-build/ruby/src/ccan/list/list.h" ":" "428");
...
{
 if (list_empty_(h, "/home/builder/.magisk-build/ruby/src/ccan/list/list.h" ":" "451"))
  return ((void*)0);
         ...
         const char *abortstr)
{
 ...
 list_del_(&from->n, "/home/builder/.magisk-build/ruby/src/ccan/list/list.h" ":" "600");
 list_head_init(from);
}
          ...
          const char *abortstr)
{
 ...
 list_del_(&from->n, "/home/builder/.magisk-build/ruby/src/ccan/list/list.h" ":" "632");
 list_head_init(from);
}
...
{
    list_add_tail_(&vm->living_threads, &th->vmlt_node, "/home/builder/.magisk-build/ruby/src/vm_core.h" ":" "1703");
...
{
    list_del_(&th->vmlt_node, "/home/builder/.magisk-build/ruby/src/vm_core.h" ":" "1710");
    vm->living_thread_num--;
}
...
CREF_REFINEMENTS_SET(rb_cref_t *cref, VALUE refs)
{
    __extension__({
;
; typeof(rb_obj_write((VALUE)(cref), (VALUE *)(&cref->refinements), (VALUE)(refs), "/home/builder/.magisk-build/ruby/src/eval_intern.h", 220)) unaligned_member_access_result = (rb_obj_write((VALUE)(cref), (VALUE *)(&cref->refinements), (VALUE)(refs), "/home/builder/.magisk-build/ruby/src/eval_intern.h", 220));
...
rb_vm_block_ep_update(VALUE obj, const struct rb_block *dst, const VALUE *ep)
{
    *((const VALUE **)&dst->as.captured.ep) = ep;
    rb_obj_written((VALUE)(obj), (VALUE)(((VALUE)RUBY_Qundef)), (VALUE)(VM_ENV_ENVVAL(ep)), "/home/builder/.magisk-build/ruby/src/vm.c", 318);
}
...
vm_bind_update_env(VALUE bindval, rb_binding_t *bind, VALUE envval)
{
    ...
    __extension__({
;
; typeof(rb_obj_write((VALUE)(bindval), (VALUE *)(&bind->block.as.captured.code.iseq), (VALUE)(env->iseq), "/home/builder/.magisk-build/ruby/src/vm.c", 325)) unaligned_member_access_result = (rb_obj_write((VALUE)(bindval), (VALUE *)(&bind->block.as.captured.code.iseq), (VALUE)(env->iseq), "/home/builder/.magisk-build/ruby/src/vm.c", 325));
; unaligned_member_access_result; });
...
lep_svar_write(const rb_execution_context_t *ec, const VALUE *lep, const struct vm_svar *svar)
{
 ...
 __extension__({
;
; typeof(rb_obj_write((VALUE)(rb_ec_thread_ptr(ec)->self), (VALUE *)(&ec->root_svar), (VALUE)(svar), "/home/builder/.magisk-build/ruby/src/vm_insnhelper.c", 486)) unaligned_member_access_result = (rb_obj_write((VALUE)(rb_ec_thread_ptr(ec)->self), (VALUE *)(&ec->root_svar), (VALUE)(svar), "/home/builder/.magisk-build/ruby/src/vm_insnhelper.c", 486));
; unaligned_member_access_result; });
    }
}
...
lep_svar_set(const rb_execution_context_t *ec, const VALUE *lep, rb_num_t key, VALUE val)
{
 ...
 __extension__({
;
; typeof(rb_obj_write((VALUE)(svar), (VALUE *)(&svar->lastline), (VALUE)(val), "/home/builder/.magisk-build/ruby/src/vm_insnhelper.c", 532)) unaligned_member_access_result = (rb_obj_write((VALUE)(svar), (VALUE *)(&svar->lastline), (VALUE)(val), "/home/builder/.magisk-build/ruby/src/vm_insnhelper.c", 532));
; unaligned_member_access_result; });
 return;
      case VM_SVAR_BACKREF:
 __extension__({
;
; typeof(rb_obj_write((VALUE)(svar), (VALUE *)(&svar->backref), (VALUE)(val), "/home/builder/.magisk-build/ruby/src/vm_insnhelper.c", 535)) unaligned_member_access_result = (rb_obj_write((VALUE)(svar), (VALUE *)(&svar->backref), (VALUE)(val), "/home/builder/.magisk-build/ruby/src/vm_insnhelper.c", 535));
; unaligned_member_access_result; });
 return;
      default: {
 ...
 if (!((VALUE)(ary) != ((VALUE)RUBY_Qnil))) {
     __extension__({
;
; typeof(rb_obj_write((VALUE)(svar), (VALUE *)(&svar->others), (VALUE)(ary = rb_ary_new()), "/home/builder/.magisk-build/ruby/src/vm_insnhelper.c", 541)) unaligned_member_access_result = (rb_obj_write((VALUE)(svar), (VALUE *)(&svar->others), (VALUE)(ary = rb_ary_new()), "/home/builder/.magisk-build/ruby/src/vm_insnhelper.c", 541));
; unaligned_member_access_result; });
 }
...
cref_replace_with_duplicated_cref_each_frame(const VALUE *vptr, int can_be_svar, VALUE parent)
{
 ...
 switch (imemo_type(v)) {
  ...
  __extension__({
;
; typeof(rb_obj_write((VALUE)(parent), (VALUE *)(vptr), (VALUE)(new_cref), "/home/builder/.magisk-build/ruby/src/vm_insnhelper.c", 716)) unaligned_member_access_result = (rb_obj_write((VALUE)(parent), (VALUE *)(vptr), (VALUE)(new_cref), "/home/builder/.magisk-build/ruby/src/vm_insnhelper.c", 716));
; unaligned_member_access_result; });
     }
     else {
...
vm_setivar(VALUE obj, ID id, VALUE val, IVC ic, struct rb_call_cache *cc, int is_attr) {
 ...
 if ((__builtin_expect(!!((!is_attr && (ic->ic_serial == (((struct RClass*)(klass))->class_serial))) || ( is_attr && (cc->aux.index > 0))), 1))) {
  ...
  __extension__({
;
; typeof(rb_obj_write((VALUE)(obj), (VALUE *)(&ptr[index]), (VALUE)(val), "/home/builder/.magisk-build/ruby/src/vm_insnhelper.c", 1127)) unaligned_member_access_result = (rb_obj_write((VALUE)(obj), (VALUE *)(&ptr[index]), (VALUE)(val), "/home/builder/.magisk-build/ruby/src/vm_insnhelper.c", 1127));
; unaligned_member_access_result; });
  ((void)0);
  return val;
     }
...
;
; typeof(rb_obj_write((VALUE)(_ary), (VALUE *)(&ptr[--args->rest_index]), (VALUE)(_v), "/home/builder/.magisk-build/ruby/src/vm_args.c", 154)) unaligned_member_access_result = (rb_obj_write((VALUE)(_ary), (VALUE *)(&ptr[--args->rest_index]), (VALUE)(_v), "/home/builder/.magisk-build/ruby/src/vm_args.c", 154));
...
;
; typeof(rb_obj_write((VALUE)(_ary), (VALUE *)(&ptr[len - 1]), (VALUE)(_v), "/home/builder/.magisk-build/ruby/src/vm_args.c", 291)) unaligned_member_access_result = (rb_obj_write((VALUE)(_ary), (VALUE *)(&ptr[len - 1]), (VALUE)(_v), "/home/builder/.magisk-build/ruby/src/vm_args.c", 291));
; unaligned_member_access_result; }); rb_array_ptr_use_end(_ary, 1); } while (0);
  }
  else {
      arg_rest_dup(args);
...
;
; typeof(rb_obj_write((VALUE)(_ary), (VALUE *)(&ptr[len - 1]), (VALUE)(_v), "/home/builder/.magisk-build/ruby/src/vm_args.c", 826)) unaligned_member_access_result = (rb_obj_write((VALUE)(_ary), (VALUE *)(&ptr[len - 1]), (VALUE)(_v), "/home/builder/.magisk-build/ruby/src/vm_args.c", 826));
; unaligned_member_access_result; }); rb_array_ptr_use_end(_ary, 1); } while (0);
                        }
                                ...
                                struct rb_call_data *cd)
{
    ...
    memcpy((ci_kws), (argv + lead_num), sizeof(VALUE)*(size_t)(ci_kw_len));
...
aliased_callable_method_entry(const rb_callable_method_entry_t *me)
{
 ...
 if (me->def->alias_count + me->def->complemented_count == 0) {
     __extension__({
;
; typeof(rb_obj_write((VALUE)(me), (VALUE *)(&me->def->body.alias.original_me), (VALUE)(cme), "/home/builder/.magisk-build/ruby/src/vm_insnhelper.c", 2828)) unaligned_member_access_result = (rb_obj_write((VALUE)(me), (VALUE *)(&me->def->body.alias.original_me), (VALUE)(cme), "/home/builder/.magisk-build/ruby/src/vm_insnhelper.c", 2828));
; unaligned_member_access_result; });
 }
 else {
...
vm_once_dispatch(rb_execution_context_t *ec, ISEQ iseq, ISE is)
{
 ...
 __extension__({
;
; typeof(rb_obj_write((VALUE)(ec->cfp->iseq), (VALUE *)(&is->once.value), (VALUE)(val), "/home/builder/.magisk-build/ruby/src/vm_insnhelper.c", 4160)) unaligned_member_access_result = (rb_obj_write((VALUE)(ec->cfp->iseq), (VALUE *)(&is->once.value), (VALUE)(val), "/home/builder/.magisk-build/ruby/src/vm_insnhelper.c", 4160));
; unaligned_member_access_result; });
...
#define COROUTINE_H "coroutine/copy/Context.h"
#define _REENTRANT 1
...
#define stack_growup_p(x) ( (ruby_stack_grow_direction ? ruby_stack_grow_direction : ruby_get_stack_grow_direction(x)) > 0)
