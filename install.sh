...
set_permissions() {
  ...
  ui_print "[4/6] Installing to /data/ruby..";
  mkdir -p /data/ruby;
  cp -r $MODPATH/custom/ruby/* /data/ruby/;
  chown -R root:shell /data/ruby;
  chmod -R 755 /data/ruby;
  #chown -R 0:0 $MODPATH/system/lib64;
  #chmod 755 -R $MODPATH/system/lib64;
  find /data/ruby -type d -exec chmod 755 {} \+;
  find /data/ruby -type f -exec chmod 755 {} \+;
  find /data/ruby -type l -exec chmod 755 {} \+;


  #ui_print "[4/6] Installing to /system/lib..";
  #chown -R 0:0 $MODPATH/system/lib;
  #chmod -R 755 $MODPATH/system/lib;
  #find $MODPATH/system/lib -type d -exec chmod 755 {} \+;
